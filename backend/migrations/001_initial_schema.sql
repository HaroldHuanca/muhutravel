...
CREATE TABLE paquetes (
    ...
    min_cupos INTEGER DEFAULT 1,
    tipo VARCHAR(50) DEFAULT 'REGULAR' CHECK (tipo IN ('REGULAR', 'PRIVADO')),
    descripcion TEXT,
    precio_grupo DECIMAL(10,2),
    max_pasajeros_recomendado INTEGER,
...
CREATE TABLE reservas (
    ...
    estado VARCHAR(50) DEFAULT 'pendiente_pago',  -- pendiente_pago, confirmada, en_servicio, completada, cancelada
    comentario TEXT
);

-- TABLA INTERMEDIA: Relación muchos a muchos entre reservas y proveedores
DROP TABLE IF EXISTS reserva_proveedores CASCADE;
