...
// Importar las rutas de comunicación
const comunicacionRouter = require('./routes/comunicacion');

// Importar servicio de integración de WhatsApp
...
// Exportar io para que sea usado por otras rutas
app.locals.io = io;

// Inicializar servicio de WhatsApp Integration
const whatsappIntegration = new WhatsAppIntegration(io);
app.locals.whatsappIntegration = whatsappIntegration;
...
class WhatsAppBot {
    ...
    async handleIncomingMessage(message) {
        try {
            ...
            // Enviar a la interfaz web (emitimos siempre para que los clientes puedan
            // decidir si mostrar la notificación o añadir el mensaje al chat activo).
            // Antes solo se enviaba a la UI si el chat estaba activo; eso provocaba
            // que mensajes que aparecen en la terminal no llegaran al cliente.
